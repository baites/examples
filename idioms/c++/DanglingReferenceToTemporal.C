...
const ObjectProbe & CreateTemporalProve(ObjectProbe probe)
{
    return probe;
}
...
{
    cout << "Creating temporal probe" << endl;
    const ObjectProbe & probe = CreateTemporalProve(ObjectProbe());
    cout << "Created temporal probe" << endl;
